...
const DeviceHistory = ({ userInfo, handleLogout }) => {
    ...
    const { device, user_id, deviceDetails: locationDeviceDetails } = location.state || {};
    
    // Use device details from location state if available, or fall back to device object
    const deviceDetails = locationDeviceDetails || device;
    ...
    const fetchSchedules = async () => {
        if (device?.serial_number) {
            ...
            try {
                const response = await fetch(`${API_BASE}/app/getSchedules?serial_number=${device.serial_number}`, {
                    headers: {
                ...
                <div className="container-fluid py-4">
                        ...
                        <div className="col-12">
                            <div className="card mb-4">
                                ...
                                <div className="card-body px-0 pt-0 pb-2">
                                    <div className="table-responsive p-0" style={{ maxHeight: '500px', overflowY: 'auto', border: '1px solid #e9ecef', margin: '0 20px', borderRadius: '12px' }}>
                                    ...
                                    {deviceHistoryData.length > 0 && pagination && (
                                        <div className="d-flex flex-column flex-md-row justify-content-between align-items-center mt-3 px-4 pb-3">
                                            {/* Results info */}
                    ...
                    <div className="row mt-4">
                        <div className="col-12">
                            <div className="card mb-4">
                                <div className="card-header pb-2">
                                    <h6>Device Schedules</h6>
                                </div>
                                <div className="card-body px-0 pt-0 pb-2">
                                    <div className="table-responsive p-0" style={{ maxHeight: '450px', overflowY: 'auto', border: '1px solid #e9ecef', margin: '0 20px', borderRadius: '12px' }}>
                                        {loadingSchedules ? (
