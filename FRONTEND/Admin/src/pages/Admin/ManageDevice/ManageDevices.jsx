...
import useManageDevices from '../../../hooks/Admin/ManageDevice/useManageDevices';
                                                        ...
                                                        <div className="form-group row">
                                                            <div className="col-sm-12" style={{ fontWeight: "bold" }}>
                                                                ...
                                                                <select
                                                                    ...
                                                                    required
                                                                >
                                                                    {users.filter((u) => u.status === true && u.role_id === 2).length === 0 ? (
                                                                        <option value="">Select Customer not found</option>
                                                                    ) : (
                                                                        <>
                                                        ...
                                                        <div className="form-group row">
                                                            <div className="col-sm-12" style={{ fontWeight: "bold" }}>
                                                                ...
                                                                <select
                                                                    ...
                                                                    required
                                                                >
                                                                    {devices.filter((d) => d.status === true && d.assign_status === false).length === 0 ? (
                                                                        <option value="">device not found</option>
                                                                    ) : (
                                                                        <>
                                                                            <option value="" disabled>
                                                                                Select Device
